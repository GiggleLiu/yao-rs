...
| qft4 | built-in | `YAO_BIN=target/debug/yao target/debug/yao example qft --nqubits 4 --json --output docs/src/examples/generated/circuits/qft4.json` | `circuits/qft4.json` | `svg/qft4.svg` | `results/qft4-probs.json` | Uniform 16-state distribution from |0000>. |
